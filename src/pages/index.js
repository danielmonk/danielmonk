...
class Header extends React.Component {
  ...
  componentDidMount () {
    ...
    // gsap animations
      ...
      iphoneFirstScroll
      .from(".phone-wrapper",1, {scale: 4.2, transformOrigin: "center center", delay: 1})
      ...
      .to(".phone-wrapper .new-york", 2, {css:{padding:"0px 82px 0 144px"}})
      ...
      .to(".phone-wrapper .new-york", 2, {css:{width: "calc(100% - 220px)", height:"calc(100% - -120px)", transform: "rotate(90deg)", right:"85px", padding:"0px 105px 0 120px"}})
      .from(".text-panel", 1, { css:{width: "0"}})
      //.from(".video-controls", 1, {css:{opacity: "1"}})
      .to(".video-controls, .phone-wrapper .new-york", 2, {css:{opacity: "0"}})
      //.to(".phone-wrapper .new-york", 1, {css:{opacity: "0"}})
      .to(".phone-wrapper", 2, { css:{right:"-25vw", width:"821px", height:"403px", /*top:"5%*/ }})
      .to(".phone-wrapper video", 2, {css:{width: "calc(100% - 398px)", height:"calc(100% + 350px)"}})
